...
-	`Chentao Li`, Pan Huang. An End-to-end Knowledge-driven Multi-instance Learning Network with Hierarchical Cluster-incorporated Aware Filtering for Larynx Pathological Grading. *IEEE Transactions on Systems, Man, and Cybernetics
* (Under Review)
</div>
</div>
